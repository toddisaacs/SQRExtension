...
public class SqrProcedureElement implements SqrElement {
    ...
    public SqrProcedureElement() {

    }
    public SqrProcedureElement(String name) {
        Name = name;
    }
    
    static {
        String path = "/teisaacs/sqrext/resources/images/procedure.JPG";
    ...
    public String getShortLabel() {
        return "SQR Procedure";
    }

    public String getLongLabel() {
        return "SQR Procedure long";
    }
